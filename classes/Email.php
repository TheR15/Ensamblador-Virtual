...
class Email {
    ...
    public function enviarConfirmacion(){
        ...
        $contenido .= "<p><strong>Hola " . $this->nombre ." </strong> Has Creado tu cuenta en Ensambler PC
        , solo debes confirmarla en el siguiente enlace </p>";

        $contenido.= "<p>Presiona aqui: <a href='http://localhost:3000/src/auth/confirmar.php?token=" .
    ...
    public function enviarInstrucciones(){
        ...
        $contenido.= "<p>Presiona aqui: <a href='http://localhost:3000/src/auth/reestablecer.php?token=" .
